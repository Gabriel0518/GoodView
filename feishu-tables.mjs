...
// ⚠️ 「未归因」渠道行：后端指标拆不到渠道时的去处（BytePlus 的 source 实测只有 39% 有标记；AI公会 的 source
...
//    PWA 的注册/IG绑定/成材已改走业务库（无渠道，全进未归因）；仅剩 GoLive 用 BytePlus 的 source 拆，
//    而 source 实测只有 39% 有标记（2026-08-16：305 里 185 无来源）→ **GoLive 的渠道拆分基本不可用**；
